...
const std::string MODEL_PATH = "vulkanTesting/asset/viking_room/viking_room.obj";
const std::string TEXTURE_PATH = "vulkanTesting/asset/viking_room/viking_room.png";
...
//        stbi_uc* pixels = stbi_load("vulkanTesting/textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        ...
        createImage(texWidth, texHeight, mipLevels, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage, textureImageMemory);
        
        // 转换布局，从 undefined 到 transfer dst
        transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mipLevels);
        // 拷贝缓存数据
        copyBufferToImage(stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight));
        // 转换布局，从 transfer dst 到 shader read，配置了 mipmap后，下面这句就不需要了，因为还要继续读写和配置
